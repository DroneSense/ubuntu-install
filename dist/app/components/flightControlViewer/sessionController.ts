...
export class SessionController {
        ...
        try {
            ...
            this.ownerSession.initializeOwnerSession(this.eventing, session, serverConnection, this.map, mapMode, allowAllGuestsWithoutPrompt, startRecording).then((ownerSession: OwnerMapSession) => {
                ...
                try {
                    ...
                    this.$log.error({ message: 'Error starting video stream ' + this.ownerSession.name, error: error });
                }
                /* !cordova-stop */
        ...
        try {
            ...
            mapSessionInstance.initializeSession(this.eventing, session, serverConnection, this.map, mapMode).then((mapSession: MapSession) => {
                ...
                try {
                    ...
                    this.$log.error({ message: 'Error subscribe video stream ' + this.activeSession.name, error: error });
                }
                /* !cordova-stop */
    ...
    endSession(): void {
        ...
        try {
            ...
            this.$log.error({ message: 'Error stopping video stream.', error: error });
        }
        /* !cordova-stop */
