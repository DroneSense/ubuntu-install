System.register(['backbone-events-standalone', './mapMode', './mapSession'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var backbone_events_standalone_1, mapMode_1, mapSession_1;
    ...
    return {
        ...
        execute: function() {
            SessionController = (function () {
                function SessionController(eventing) {
                ...
                SessionController.prototype.addGuestSession = function (session, serverConnection, mapMode) {
                    ...
                    this.initializeMap(mapMode);
                    var mapSessionInstance = new mapSession_1.MapSession();
