System.register(['@dronesense/model/lib/common/Utility'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            TakeoffCommandInstance = (function () {
                function TakeoffCommandInstance(bindings, db) {
                    var _this = this;
                ...
                TakeoffCommandInstance.prototype.UpdateAltitude = function () {
                    var _this = this;
                    ...
                    Cesium.sampleTerrain(terrainProvider, 15, positions).then(function (updatedPositions) {
                        ...
                        _this.command.UpdateProperties({
                            Altitude: _this.altitude,
                            GroundElevationMSL: updatedPositions[0].height,
                            GroundElevationHAE: updatedPositions[0].height,
                            AltitudeMSL: updatedPositions[0].height + _this.altitude,
                            AltitudeHAE: updatedPositions[0].height + _this.altitude
                        });
                    });
                };
                TakeoffCommandInstance.prototype.UpdatePosition = function () {
                    // Save property on model
                    this.command.SaveProperty(this.position, 'Position');
                    this.UpdateAltitude();
                };
                // Remove self from map then call viewer for removal
                TakeoffCommandInstance.prototype.Delete = function () {
                    // Remove UI from map
                ...
                TakeoffCommandInstance.prototype.FlyTo = function () {
                    this.map.flyTo(this.entity);
                };
                // Toggle visibility on map
                TakeoffCommandInstance.prototype.HideShow = function () {
                    this.entity.show = !this.entity.show;
                };
                // Bind two way fields that are also update
                TakeoffCommandInstance.prototype.SetupViewData = function () {
                    var _this = this;
                    ...
                    this.bindings.$watch(function () { return _this.command.ClimbSpeed; }, function (newValue, oldValue) {
                        _this.climbSpeed = _this.command.ClimbSpeed;
                    });
                ...
                TakeoffCommandInstance.prototype.SetupEditingHandlers = function () {
                    this.editingHandler = new Cesium.ScreenSpaceEventHandler(this.map.canvas);
                };
                // </editor-fold>
                // <editor-fold desc="Map UI Generation Code">
                TakeoffCommandInstance.prototype.generateMapUI = function () {
                    var _this = this;
                ...
                TakeoffCommandInstance.prototype.Edit = function () {
                    var _this = this;
                    if (this.isEditing) {
                        this.isEditing = false;
                ...
                TakeoffCommandInstance.prototype.TrackEntity = function () {
                    this.onTrackEntity({ id: this.entity.id });
                };
                // Constructor
                TakeoffCommandInstance.$inject = [
                    '$scope',
                    'db'
                ];
                return TakeoffCommandInstance;
            }());
            exports_1("default",angular.module('DroneSense.Web.Tools.TakeoffCommandInstance', []).component('dsTakeoffCommandInstance', {
                transclude: true,
                bindings: {
                    command: '<',
                    onCommandChange: '&',
...
//# sourceMappingURL=takeoffCommandInstance.js.map
