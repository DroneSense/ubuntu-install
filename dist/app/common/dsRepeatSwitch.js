System.register([], function(exports_1, context_1) {
    ...
    return {
        setters:[],
        execute: function() {
            exports_1("default",angular.module('DroneSense.Web.RepeatSwitch', []).directive('bnRepeatSwitch', ['$parse', '$compile',
                function ($parse, $compile) {
                    ...
                    function compile(tElement, tAttributes) {
                        ...
                        tElement
                            ...
                            .remove()
                            .each(function iterateOverCaseTemplates() {
            ...
            ]).directive('bnRepeatSwitch', function () {
                ...
                function link(scope, element, attributes, switchController) {
                    ...
                    var stopWatching = scope.$watch(switchController.expression, function handleSwitchExpressionChange(newValue, oldValue) {
                        ...
                        linkFunction(scope, function handleCaseTemplateCloneLinking(clone) {
...
//# sourceMappingURL=dsRepeatSwitch.js.map
